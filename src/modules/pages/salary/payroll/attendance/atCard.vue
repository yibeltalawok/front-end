  ...
  <v-layout row justify-space-around>
    <div class="status-card">
      ...
      <div class="status-card__content">
        ...
        <div class="number">{{ this.numberOfPresents }}</div>
        <div class="description">Total present employees</div>
      </div>
    </div>
    ...
    <div class="status-card">
      ...
      <div class="status-card__content">
        ...
        <div class="number">{{ this.numberOfAbsents }}</div>
        <div class="description">Total absent employees</div>
      </div>
    </div>
    ...
    <div class="status-card">
      ...
      <div class="status-card__content">
        ...
        <div class="number">{{ this.numberOfReasons }}</div>
        <div class="description">Total absent employees with reasons</div>
      </div>
    </div>

    <!-- <div class="col-md-4">
      <div class="status-card status-card">
...
export default {
  ...
  data() {
    return {
      avatar: "https://www.footballtodaylive.com/team-logo/Laurent-Jans.png",
    };
  },
};
</script>
